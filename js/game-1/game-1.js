...
import gameTwoView from '../game-2/game-2-view.js';
import headerView from '../header/header.js';

const gameOneView = new GameOneView();

gameOneView.changeImagesSizes();
...
gameOneView.onClick = () => {
  ...
  gameAnswer.forEach((elem) => elem.addEventListener(`click`, () => {
    ...
    if (gameAnswer[0].checked || gameAnswer[1].checked) {
      ...
      console.log(clickCounterForLeftPicture === 1);
    ...
    if (gameAnswer[2].checked || gameAnswer[3].checked) {
      ...
      console.log(clickCounterForRightPicture);
